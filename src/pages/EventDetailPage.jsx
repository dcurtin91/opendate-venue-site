    ...
    <div className="event-detail">
      ...
      <div className="container event-detail-body">
        <div className="event-detail-main">
          ...
          {/* Get to know Your Creator — lakeside events */}
          {hasTag("lakeside") && (
            <section className="event-section creator-section">
              <h3 className="creator-heading">Get to Know Your Creator & Host</h3>
              <div className="creator-card">
                <img
                  src="/Alix_Headshot_018_R3.jpeg"
                  alt="Alix Earle"
                  className="creator-img"
                />
                <CreatorBio name="Alix Earle" bioText={CREATOR_5_BIO} />
              </div>
              <div className="creator-card" style={{ marginTop: 24 }}>
                <img
                  src="/HEADSHOT.JPG"
                  ...
                  className="creator-img"
                />
                <CreatorBio name="Brandon Edelman" bioText={CREATOR_6_BIO} />
              </div>
            </section>
          )}
